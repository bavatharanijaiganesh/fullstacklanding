...
import {
  ...
  Search, BarChart, Terminal, Hammer, Brain, Target, BookOpen, Bot, Phone, Rocket, Mail,
...
const Fullstack = () => {
  ...
  const themeColors = {
    red: 'rgba(239, 72, 42)',
    redDark: 'rgba(210, 50, 25)',
    redLight: 'rgba(255, 95, 65)',
    redBg: 'rgba(239, 72, 42, 0.08)',
    redBorder: 'rgba(239, 72, 42, 0.25)',
    white: '#ffffff',
    offWhite: '#f8f8f8',
    lightGray: '#f0f0f0',
    border: '#e5e7eb',
    ...
    surface: '#ffffff',
    surfaceSub: '#f9fafb',
    gradientRed: 'linear-gradient(135deg, rgba(239, 72, 42) 0%, rgba(210, 50, 25) 100%)',
    gradientRedLight: 'linear-gradient(135deg, rgba(255, 95, 65) 0%, rgba(239, 72, 42) 100%)',
    gradientHero: 'linear-gradient(135deg, #fff5f5 0%, #ffffff 60%, #fff0f0 100%)',
  };
  ...
  useEffect(() => {
    ...
    // SEO meta info
    document.title = 'Full Stack Developer Course in Coimbatore | Placement Training | PeopleClick';
    ...
    upsertMeta('description', 'Join the best Full Stack Development course in Coimbatore & Bangalore. Learn HTML, CSS, JavaScript, React, Node.js & more with real projects. 100% placement support.');
    upsertMeta('keywords', 'Full Stack Developer Course in Coimbatore, Full Stack Training in Bangalore, Web Development Course with Placement, Full Stack Course for Beginners, Learn Web Development Course, Frontend and Backend Course, React JS Training in Coimbatore, Node JS Course in Bangalore, Best full stack developer course in Coimbatore with placement, Full stack training for beginners without coding experience, Web development course with real-time projects in Bangalore, Learn full stack development from scratch in India');
    upsertMeta('robots', 'index, follow');
    upsertMeta('author', 'PeopleClick Learning');
    upsertMeta('og:title', 'Full Stack Developer Course in Coimbatore | Placement Training | PeopleClick', true);
    upsertMeta('og:description', 'Join the best Full Stack Development course in Coimbatore & Bangalore. Learn HTML, CSS, JavaScript, React, Node.js & more with real projects. 100% placement support.', true);
    upsertMeta('og:type', 'website', true);
    upsertMeta('twitter:card', 'summary_large_image');
    upsertMeta('twitter:title', 'Full Stack Developer Course in Coimbatore | Placement Training | PeopleClick');
    upsertMeta('twitter:description', 'Join the best Full Stack Development course in Coimbatore & Bangalore. Learn HTML, CSS, JavaScript, React, Node.js & more with real projects. 100% placement support.');
  ...
  return (
    ...
    >
      <style dangerouslySetInnerHTML={{
        ...
        .red-card:hover { border-color: rgba(239,72,42,0.5) !important; transform: translateY(-4px); }
        input:focus, select:focus { border-color: rgba(239,72,42,1) !important; box-shadow: 0 0 0 3px rgba(239,72,42,0.1); }
        .gradient-text { background: linear-gradient(135deg, rgba(223,51,67) 0%, rgba(235,70,46) 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; display: inline-block; }
        `
      }} />
      ...
      <header className="sticky top-0 z-50 bg-white border-b" style={{ borderColor: themeColors.border, boxShadow: '0 1px 8px rgba(0,0,0,0.08)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-center md:justify-end gap-2 w-full sm:w-auto">
            ...
            <a href="#lead-form" className="w-full sm:w-60 md:w-auto text-center text-white font-bold text-xs sm:text-sm py-2 px-5 rounded-full transition-all hover:scale-105"
              style={{ background: themeColors.gradientRed, boxShadow: '0 4px 14px rgba(239,72,42,0.35)' }}>
              Get Free Demo
            </a>
          </div>
        </div>
      ...
      <div className="relative overflow-hidden w-full" style={{ background: themeColors.gradientHero }}>
        ...
        <div className="absolute top-0 right-0 w-[500px] h-[500px] rounded-full pointer-events-none" style={{ background: 'radial-gradient(circle, rgba(239,72,42,0.07) 0%, transparent 70%)' }}></div>
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full pointer-events-none" style={{ background: 'radial-gradient(circle, rgba(239,72,42,0.05) 0%, transparent 70%)' }}></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 lg:py-24 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            <div className="lg:col-span-7 fade-up">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black leading-[1.1] mb-6" style={{ color: themeColors.text }}>
                <span>Full Stack <span className="gradient-text">Development</span></span>
                <div className="flex items-center gap-3 md:gap-4 mt-2 sm:mt-3 text-3xl sm:text-4xl lg:text-5xl" style={{ color: themeColors.text }}>
                  <span className="gradient-text" style={{ fontWeight: 300, opacity: 0.7 }}>|</span>
                  <span className="font-bold tracking-tight">Development</span>
                </div>
              </h1>

              <p className="text-lg mb-8 max-w-2xl leading-relaxed" style={{ color: themeColors.textMuted }}>
                No.1 Full Stack Development Course in Coimbatore & Bangalore. Learn React, Node.js, MongoDB, and modern web technologies with hands-on projects and placement support. Earn an <a href="#internship-section" className="font-bold transition-all cursor-pointer hover:opacity-80 gradient-text">exclusive IT company internship</a>.
              </p>
              ...
              <div className="grid grid-cols-3 gap-6 pt-6 border-t max-w-xl" style={{ borderColor: themeColors.border }}>
                ...
                <div>
                  <div className="text-3xl font-black mb-1 gradient-text">₹5-10LPA</div>
            ...
            <div className="lg:col-span-5 relative" id="lead-form">
              <div className="relative rounded-2xl p-6 sm:p-8 shadow-xl border" style={{ backgroundColor: themeColors.white, borderColor: themeColors.border, boxShadow: '0 8px 40px rgba(239,72,42,0.10)' }}>
                {/* Red top accent bar */}
      ...
      <section className="py-16 border-b" style={{ backgroundColor: themeColors.white, borderColor: themeColors.border }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-black mb-4" style={{ color: themeColors.text }}>Full Stack Development Course in Coimbatore with Placement Assistance</h2>
          <p className="text-lg mb-3" style={{ color: themeColors.textMuted }}>Build cutting-edge web applications and launch a high-paying career with Peopleclick's Full Stack Development Course in Coimbatore.</p>
          <p className="text-lg mb-5" style={{ color: themeColors.textMuted }}>Learn from industry experts, build real-world projects, and become job-ready with our placement-focused training program.</p>
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="border p-6 rounded-2xl" style={{ borderColor: themeColors.border, backgroundColor: themeColors.offWhite }}>
              <h3 className="text-xl font-bold mb-3" style={{ color: themeColors.text }}>How to Actually Build a Career in Full Stack Development (Simple & Actionable)</h3>
              <ol className="list-decimal list-inside space-y-4" style={{ color: themeColors.textMuted }}>
                ...
                <li>
                  ...
                  <p className="mt-2 font-semibold gradient-text">Result: You match real job roles like Full Stack & MERN Developer</p>
                </li>
                <li>
            ...
            <div className="border p-6 rounded-2xl" style={{ borderColor: themeColors.border, backgroundColor: themeColors.offWhite }}>
              <h3 className="text-xl font-bold mb-3" style={{ color: themeColors.text }}>Why Choose Full Stack Development as a Career?</h3>
              <ul className="list-disc list-inside pl-5 space-y-2" style={{ color: themeColors.textMuted }}>
                ...
                <li>Attractive salary packages (₹5-18 LPA)</li>
          ...
          <div className="mt-10">
            <h3 className="text-2xl font-black mb-4" style={{ color: themeColors.text }}>Full Stack Course Syllabus</h3>
          ...
          <div className="mt-10">
            ...
            <ul className="list-disc list-inside pl-5 space-y-1" style={{ color: themeColors.textMuted }}>
              ...
              <li>Experienced: ₹10 LPA – ₹25 LPA</li>
            </ul>
          ...
          <div className="mt-10 border p-6 rounded-2xl" style={{ borderColor: themeColors.border, backgroundColor: themeColors.offWhite }}>
            ...
            <div className="space-y-4" style={{ color: themeColors.textMuted }}>
              <div>
                <p className="font-bold" style={{ color: themeColors.text }}>What is the best Full Stack Developer course in Coimbatore with placement support?</p>
                <p>PeopleClick offers one of the best full stack development courses with hands-on training, real-time projects, and placement assistance.</p>
              </div>
              <div>
                <p className="font-bold" style={{ color: themeColors.text }}>Which institute provides practical Full Stack training in Bangalore and Coimbatore?</p>
                <p>PeopleClick provides practical training covering frontend, backend, and real-time project experience across both Coimbatore and Bangalore centres.</p>
              </div>
              <div>
                <p className="font-bold" style={{ color: themeColors.text }}>What technologies are covered in a Full Stack Developer course?</p>
                <p>The course includes HTML, CSS, JavaScript, React, Node.js, Express.js, MongoDB, MySQL, Git, REST APIs, and Postman — everything companies are actively hiring for.</p>
              </div>
              <div>
                <p className="font-bold" style={{ color: themeColors.text }}>Can beginners learn Full Stack Development without programming experience?</p>
                <p>Yes, beginners can start from scratch and gradually learn all technologies step by step. No prior coding knowledge is required.</p>
              </div>
              <div>
                <p className="font-bold" style={{ color: themeColors.text }}>What is the salary of a Full Stack Developer in India?</p>
                <p>Freshers can earn ₹3–₹7 LPA, mid-level developers earn ₹8–₹15 LPA, and experienced developers can earn ₹20 LPA+. Freelancing and remote jobs can further increase global earning potential.</p>
              </div>
              <div>
                <p className="font-bold" style={{ color: themeColors.text }}>How long does it take to complete a Full Stack course?</p>
                <p>Typically, it takes 2 to 4 months depending on your learning schedule. Both weekday and weekend batches are available.</p>
              </div>
              <div>
                <p className="font-bold" style={{ color: themeColors.text }}>Is Full Stack Development a good career in 2026?</p>
                <p>Yes, it is one of the most in-demand and stable career options in the tech industry. Over 70% of companies prefer hiring full stack developers and demand is growing faster than most other careers.</p>
              </div>
              <div>
                <p className="font-bold" style={{ color: themeColors.text }}>Do Full Stack courses include real-time projects?</p>
                <p>Yes, PeopleClick provides real-time projects such as e-commerce platforms, dashboards, REST APIs, and chat applications to help you gain practical experience.</p>
              </div>
              <div>
                <p className="font-bold" style={{ color: themeColors.text }}>Will I get placement assistance after completing the course?</p>
                <p>Yes, placement support, resume building, and interview preparation are all included. PeopleClick supports you until you land your dream developer role.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              { icon: <Building className="w-10 h-10" color={themeColors.red} />, title: 'Diploma Holders', desc: 'Diploma graduates in computer science or related fields looking to advance their careers in tech.' },
      ...
      <section className="py-20" style={{ backgroundColor: themeColors.white }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: 'Full Stack Developer', salary: '₹5-12 LPA', desc: 'Build and maintain both client-side and server-side of web applications using modern technologies.' },
              { title: 'MERN Stack Developer', salary: '₹6-14 LPA', desc: 'Specialize in MongoDB, Express, React, and Node.js stack for building scalable web applications.' },
              { title: 'Frontend React Developer', salary: '₹5-11 LPA', desc: 'Create responsive, high-performance user interfaces with React.js, Redux, and modern CSS frameworks.' },
              { title: 'Backend Node.js Developer', salary: '₹5-10 LPA', desc: 'Design and build RESTful APIs, microservices, and server-side logic with Node.js and Express.' },
              { title: 'Software Engineer', salary: '₹6-15 LPA', desc: 'Work on software lifecycle from design to deployment in agile teams at top product companies.' },
              { title: 'Web App Architect', salary: '₹12-25 LPA', desc: 'Design scalable system architectures, lead development teams, and define technical standards.' },
              { title: 'DevOps Engineer', salary: '₹8-18 LPA', desc: 'Automate CI/CD pipelines, manage cloud infrastructure, and ensure smooth software delivery.' },
              { title: 'Freelance Developer', salary: '₹3-20 LPA', desc: 'Work on independent projects for global clients and build your own business as a Full Stack freelancer.' },
            ].map((role, i) => (
              <div key={i} className="bg-white border p-6 rounded-2xl red-card transition-all group"
                ...
                <div className="flex justify-between items-start mb-4">
                  ...
                  <span className="text-sm font-semibold px-2 py-1 rounded-md border whitespace-nowrap"
                    style={{ backgroundColor: 'rgba(239,72,42,0.07)', borderColor: themeColors.redBorder }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div ref={toolsRef} className="flex gap-5 overflow-x-auto pb-2 md:grid md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 md:overflow-visible md:pb-0 snap-x snap-mandatory scrollbar-thin">
            {[
              ...
              { name: 'Node.js', icon: <Cpu className="w-10 h-10 mx-auto" color={themeColors.red} />, desc: 'Backend Runtime' },
              { name: 'MongoDB', icon: <Database className="w-10 h-10 mx-auto" color={themeColors.red} />, desc: 'NoSQL Database' },
              { name: 'Express.js', icon: <Terminal className="w-10 h-10 mx-auto" color={themeColors.red} />, desc: 'Web Framework' },
              { name: 'MySQL', icon: <Layers className="w-10 h-10 mx-auto" color={themeColors.red} />, desc: 'SQL Database' },
              { name: 'Git & GitHub', icon: <Code className="w-10 h-10 mx-auto" color={themeColors.red} />, desc: 'Version Control' },
              { name: 'Next.js', icon: <BarChart className="w-10 h-10 mx-auto" color={themeColors.red} />, desc: 'React Framework' },
              { name: 'Docker', icon: <Search className="w-10 h-10 mx-auto" color={themeColors.red} />, desc: 'Containerization' },
            ].map((tool, i) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-2 lg:order-1">
              ...
              <a href="#lead-form" className="inline-block text-white font-bold py-3 px-8 rounded-lg transition-all hover:-translate-y-1"
                style={{ background: themeColors.gradientRed, boxShadow: '0 4px 20px rgba(239,72,42,0.35)' }}>
            ...
            <div className="order-1 lg:order-2 relative">
              <div className="absolute inset-0 rounded-2xl blur-2xl" style={{ background: 'radial-gradient(circle, rgba(239,72,42,0.12), transparent 70%)' }}></div>
      ...
      {/* ── BATCH & PRICING CTA ── */}
      <section className="py-24 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #fff5f5 0%, #fff 50%, #fff5f5 100%)' }}>
        <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse at top right, rgba(239,72,42,0.08) 0%, transparent 60%)' }}></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="border-2 p-5 rounded-xl flex justify-between items-center"
                  style={{ borderColor: themeColors.red, backgroundColor: 'rgba(239,72,42,0.04)' }}>
                  <div>
                  ...
                  <span className="text-xs font-bold px-3 py-1 rounded-full whitespace-nowrap"
                    style={{ backgroundColor: 'rgba(239,72,42,0.1)', borderColor: themeColors.redBorder, border: `1px solid ${themeColors.redBorder}` }}>
              ...
              <div className="mt-10 flex flex-wrap gap-4">
                <a href="#lead-form" className="text-white font-bold py-4 px-8 rounded-lg transition-transform hover:scale-105"
                  style={{ background: themeColors.gradientRed, boxShadow: '0 4px 14px rgba(239,72,42,0.35)' }}>
            ...
            <div className="bg-white border-2 p-8 sm:p-10 rounded-3xl relative max-w-md mx-auto w-full shadow-xl"
              style={{ borderColor: themeColors.red, boxShadow: '0 8px 40px rgba(239,72,42,0.15)' }}>
